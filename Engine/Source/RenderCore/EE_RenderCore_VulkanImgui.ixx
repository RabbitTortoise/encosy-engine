...
export module EE_RenderCore_VulkanImgui;
...
public:
	...
	void InitImgui(int minAlloctionSize)
	{
		...
		ImGui_ImplSDL3_InitForVulkan(EncosyEngine::WindowManager::GetMainWindow());
		...
		EncosyEngine::WindowManager::SubscribeToMainWindowEvents([&](SDL_Event event) {
