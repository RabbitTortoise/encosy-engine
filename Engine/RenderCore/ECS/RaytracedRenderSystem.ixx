...
export module Systems.RaytracedRenderSystem;
...
export class RaytracedRenderSystem : public SystemThreaded
{
...
public:
	RaytracedRenderSystem(RenderCore* engineRenderCore)
	{ 
...
protected:
	...
	{
		TransformComponent transformComponent = GetCurrentEntityComponent(thread, &TransformComponents);
		//ModelMatrixComponent matrixComponent = GetCurrentEntityComponent(thread, &ModelMatrixComponents);
		MaterialComponentRaytracing raytracingComponent = GetCurrentEntityComponent(thread, &MaterialComponents);
...
private:
	...
	TransformComponent CurrentCameraTransformComponent;
	...
	ReadOnlyAlwaysFetchedStorage<CameraComponent> CameraComponents;
	ReadOnlyAlwaysFetchedStorage<TransformComponent> CameraTransformComponents;
