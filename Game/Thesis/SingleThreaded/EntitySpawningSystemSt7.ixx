...
export module Thesis.Systems.ThesisEntitySpawningSystemSt7;
...
export class ThesisEntitySpawningSystemSt7 : public System
{
	friend class SystemManager;

public:
	ThesisEntitySpawningSystemSt7(const int entityModificationsPerFrame, TextureLoader* textureLoader, MeshLoader* meshLoader) :
	...
	~ThesisEntitySpawningSystemSt7() override {}
