...
export module Thesis.Systems.ThesisEntitySpawningSystemSt2;
...
export class ThesisEntitySpawningSystemSt2 : public System
{
	friend class SystemManager;

public:
	ThesisEntitySpawningSystemSt2(const int entityModificationsPerFrame, TextureLoader* textureLoader, MeshLoader* meshLoader) :
	...
	~ThesisEntitySpawningSystemSt2() override {}
