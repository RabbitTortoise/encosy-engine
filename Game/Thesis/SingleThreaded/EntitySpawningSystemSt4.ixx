...
export module Thesis.Systems.ThesisEntitySpawningSystemSt4;
...
export class ThesisEntitySpawningSystemSt4 : public System
{
	friend class SystemManager;

public:
	ThesisEntitySpawningSystemSt4(const int entityModificationsPerFrame, TextureLoader* textureLoader, MeshLoader* meshLoader) :
	...
	~ThesisEntitySpawningSystemSt4() override {}
