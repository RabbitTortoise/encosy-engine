...
export module Thesis.Systems.ThesisEntitySpawningSystemSt1;
...
export class ThesisEntitySpawningSystemSt1 : public System
{
	friend class SystemManager;

public:
	ThesisEntitySpawningSystemSt1(const int entityModificationsPerFrame, TextureLoader* textureLoader, MeshLoader* meshLoader) :
	...
	~ThesisEntitySpawningSystemSt1() override {}
