...
export module Thesis.Systems.ThesisEntitySpawningSystemSt9;
...
export class ThesisEntitySpawningSystemSt9 : public System
{
	friend class SystemManager;

public:
	ThesisEntitySpawningSystemSt9(const int entityModificationsPerFrame, TextureLoader* textureLoader, MeshLoader* meshLoader) :
	...
	~ThesisEntitySpawningSystemSt9() override {}
