...
export module Thesis.Systems.ThesisEntitySpawningSystemSt3;
...
export class ThesisEntitySpawningSystemSt3 : public System
{
	friend class SystemManager;

public:
	ThesisEntitySpawningSystemSt3(const int entityModificationsPerFrame, TextureLoader* textureLoader, MeshLoader* meshLoader) :
	...
	~ThesisEntitySpawningSystemSt3() override {}
