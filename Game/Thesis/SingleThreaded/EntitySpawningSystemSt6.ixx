...
export module Thesis.Systems.ThesisEntitySpawningSystemSt6;
...
export class ThesisEntitySpawningSystemSt6 : public System
{
	friend class SystemManager;

public:
	ThesisEntitySpawningSystemSt6(const int entityModificationsPerFrame, TextureLoader* textureLoader, MeshLoader* meshLoader) :
	...
	~ThesisEntitySpawningSystemSt6() override {}
