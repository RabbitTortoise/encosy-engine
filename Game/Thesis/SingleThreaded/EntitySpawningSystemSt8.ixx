...
export module Thesis.Systems.ThesisEntitySpawningSystemSt8;
...
export class ThesisEntitySpawningSystemSt8 : public System
{
	friend class SystemManager;

public:
	ThesisEntitySpawningSystemSt8(const int entityModificationsPerFrame, TextureLoader* textureLoader, MeshLoader* meshLoader) :
	...
	~ThesisEntitySpawningSystemSt8() override {}
