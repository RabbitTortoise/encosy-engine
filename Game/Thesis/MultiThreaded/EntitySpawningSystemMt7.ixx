...
export module Thesis.Systems.ThesisEntitySpawningSystemMt7;
...
export class ThesisEntitySpawningSystemMt7 : public SystemThreaded
{
...
public:
	ThesisEntitySpawningSystemMt7(const int entityModificationsPerFrame, TextureLoader* textureLoader, MeshLoader* meshLoader, bool allowConcurrent) :
	...
	~ThesisEntitySpawningSystemMt7() override {}
...
protected:
	void Init() override
	{
		...
		SystemEntityType = GetEntityTypeInfo("EntityType7").Type;
	...
	void Update(const int thread, const double deltaTime) override 
	{
		...
		EntityTypeComponent7 entityType = {};
