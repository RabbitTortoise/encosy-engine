...
export module Thesis.Systems.ThesisEntityDestroySystemMt2;
...
export class ThesisEntityDestroySystemMt2 : public SystemThreaded
{
...
public:
	ThesisEntityDestroySystemMt2(bool allowConcurrent)
	{
		ThreadedRunOptions.PreferRunAlone = !allowConcurrent;
	}
	~ThesisEntityDestroySystemMt2() override {}
...
protected:
	void Init() override
	{
		...
		SystemEntityType = GetEntityTypeInfo("EntityToDestroy2").Type;
