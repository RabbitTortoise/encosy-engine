...
export module Thesis.Systems.ThesisEntityDestroySystemMt7;
...
export class ThesisEntityDestroySystemMt7 : public SystemThreaded
{
...
public:
	ThesisEntityDestroySystemMt7(bool allowConcurrent)
	{
		ThreadedRunOptions.PreferRunAlone = !allowConcurrent;
	}
	~ThesisEntityDestroySystemMt7() override {}
...
protected:
	void Init() override
	{
		...
		SystemEntityType = GetEntityTypeInfo("EntityToDestroy7").Type;
