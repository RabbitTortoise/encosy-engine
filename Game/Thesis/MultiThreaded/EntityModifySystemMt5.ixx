...
export module Thesis.Systems.ThesisEntityModifySystemMt5;
...
export class ThesisEntityModifySystemMt5 : public SystemThreaded
{
...
public:
	...
	ThesisEntityModifySystemMt5(bool allowConcurrent)
	{
		ThreadedRunOptions.PreferRunAlone = !allowConcurrent;
	}
	~ThesisEntityModifySystemMt5() override {}
...
protected:
	void Init() override
	{
		...
		SystemEntityToDestroyType = GetEntityTypeInfo("EntityToDestroy5").Type;
