...
export module Thesis.Systems.ThesisEntityDestroySystemMt5;
...
export class ThesisEntityDestroySystemMt5 : public SystemThreaded
{
...
public:
	ThesisEntityDestroySystemMt5(bool allowConcurrent)
	{
		ThreadedRunOptions.PreferRunAlone = !allowConcurrent;
	}
	~ThesisEntityDestroySystemMt5() override {}
...
protected:
	void Init() override
	{
		...
		SystemEntityType = GetEntityTypeInfo("EntityToDestroy5").Type;
