...
export module Thesis.Systems.ThesisEntitySpawningSystemMt2;
...
export class ThesisEntitySpawningSystemMt2 : public SystemThreaded
{
...
public:
	ThesisEntitySpawningSystemMt2(const int entityModificationsPerFrame, TextureLoader* textureLoader, MeshLoader* meshLoader, bool allowConcurrent) :
	...
	~ThesisEntitySpawningSystemMt2() override {}
...
protected:
	...
	void Update(const int thread, const double deltaTime) override 
	{
		...
		EntityTypeComponent2 entityType = {};
