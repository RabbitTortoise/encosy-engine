...
export module Thesis.Systems.ThesisEntitySpawningSystemMt4;
...
export class ThesisEntitySpawningSystemMt4 : public SystemThreaded
{
...
public:
	ThesisEntitySpawningSystemMt4(const int entityModificationsPerFrame, TextureLoader* textureLoader, MeshLoader* meshLoader, bool allowConcurrent) :
	...
	~ThesisEntitySpawningSystemMt4() override {}
...
protected:
	...
	void Update(const int thread, const double deltaTime) override 
	{
		...
		EntityTypeComponent4 entityType = {};
