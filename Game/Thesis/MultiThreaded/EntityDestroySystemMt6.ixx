...
export module Thesis.Systems.ThesisEntityDestroySystemMt6;
...
export class ThesisEntityDestroySystemMt6 : public SystemThreaded
{
...
public:
	ThesisEntityDestroySystemMt6(bool allowConcurrent)
	{
		ThreadedRunOptions.PreferRunAlone = !allowConcurrent;
	}
	~ThesisEntityDestroySystemMt6() override {}
...
protected:
	void Init() override
	{
		...
		SystemEntityType = GetEntityTypeInfo("EntityToDestroy6").Type;
