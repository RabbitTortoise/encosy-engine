...
export module Thesis.Systems.ThesisEntitySpawningSystemMt6;
...
export class ThesisEntitySpawningSystemMt6 : public SystemThreaded
{
...
public:
	ThesisEntitySpawningSystemMt6(const int entityModificationsPerFrame, TextureLoader* textureLoader, MeshLoader* meshLoader, bool allowConcurrent) :
	...
	~ThesisEntitySpawningSystemMt6() override {}
...
protected:
	...
	void Update(const int thread, const double deltaTime) override 
	{
		...
		EntityTypeComponent6 entityType = {};
