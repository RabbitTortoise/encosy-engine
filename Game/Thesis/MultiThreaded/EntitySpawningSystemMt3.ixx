...
export module Thesis.Systems.ThesisEntitySpawningSystemMt3;
...
export class ThesisEntitySpawningSystemMt3 : public SystemThreaded
{
...
public:
	ThesisEntitySpawningSystemMt3(const int entityModificationsPerFrame, TextureLoader* textureLoader, MeshLoader* meshLoader, bool allowConcurrent) :
	...
	~ThesisEntitySpawningSystemMt3() override {}
...
protected:
	void Init() override
	{
		...
		SystemEntityType = GetEntityTypeInfo("EntityType3").Type;
	...
	void Update(const int thread, const double deltaTime) override 
	{
		...
		EntityTypeComponent3 entityType = {};
