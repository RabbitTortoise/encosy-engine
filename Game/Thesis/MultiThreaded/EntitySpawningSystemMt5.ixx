...
export module Thesis.Systems.ThesisEntitySpawningSystemMt5;
...
export class ThesisEntitySpawningSystemMt5 : public SystemThreaded
{
...
public:
	ThesisEntitySpawningSystemMt5(const int entityModificationsPerFrame, TextureLoader* textureLoader, MeshLoader* meshLoader, bool allowConcurrent) :
	...
	~ThesisEntitySpawningSystemMt5() override {}
