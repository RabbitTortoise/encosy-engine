...
export module Thesis.Systems.ThesisEntityDestroySystemMt8;
...
export class ThesisEntityDestroySystemMt8 : public SystemThreaded
{
...
public:
	ThesisEntityDestroySystemMt8(bool allowConcurrent)
	{
		ThreadedRunOptions.PreferRunAlone = !allowConcurrent;
	}
	~ThesisEntityDestroySystemMt8() override {}
...
protected:
	void Init() override
	{
		...
		SystemEntityType = GetEntityTypeInfo("EntityToDestroy8").Type;
