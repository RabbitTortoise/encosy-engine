...
export module Thesis.Systems.ThesisEntityModifySystemMt7;
...
export class ThesisEntityModifySystemMt7 : public SystemThreaded
{
...
public:
	...
	ThesisEntityModifySystemMt7(bool allowConcurrent)
	{
		ThreadedRunOptions.PreferRunAlone = !allowConcurrent;
	}
	~ThesisEntityModifySystemMt7() override {}
...
protected:
	void Init() override
	{
		...
		SystemEntityToDestroyType = GetEntityTypeInfo("EntityToDestroy7").Type;
