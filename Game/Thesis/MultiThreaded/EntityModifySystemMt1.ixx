...
export module Thesis.Systems.ThesisEntityModifySystemMt1;
...
export class ThesisEntityModifySystemMt1 : public SystemThreaded
{
...
public:
	...
	ThesisEntityModifySystemMt1(bool allowConcurrent)
	{
		ThreadedRunOptions.PreferRunAlone = !allowConcurrent;
	}
	~ThesisEntityModifySystemMt1() override {}
...
protected:
	void Init() override
	{
		...
		SystemEntityToDestroyType = GetEntityTypeInfo("EntityToDestroy1").Type;
