...
export module Thesis.Systems.ThesisEntityModifySystemMt3;
...
export class ThesisEntityModifySystemMt3 : public SystemThreaded
{
...
public:
	...
	ThesisEntityModifySystemMt3(bool allowConcurrent)
	{
		ThreadedRunOptions.PreferRunAlone = !allowConcurrent;
	}
	~ThesisEntityModifySystemMt3() override {}
...
protected:
	void Init() override
	{
		...
		SystemEntityToDestroyType = GetEntityTypeInfo("EntityToDestroy3").Type;
