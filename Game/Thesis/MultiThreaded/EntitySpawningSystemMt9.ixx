...
export module Thesis.Systems.ThesisEntitySpawningSystemMt9;
...
export class ThesisEntitySpawningSystemMt9 : public SystemThreaded
{
...
public:
	ThesisEntitySpawningSystemMt9(const int entityModificationsPerFrame, TextureLoader* textureLoader, MeshLoader* meshLoader, bool allowConcurrent) :
	...
	~ThesisEntitySpawningSystemMt9() override {}
...
protected:
	...
	void Update(const int thread, const double deltaTime) override 
	{
		...
		EntityTypeComponent9 entityType = {};
