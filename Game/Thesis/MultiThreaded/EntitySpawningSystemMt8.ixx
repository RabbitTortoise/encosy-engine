...
export module Thesis.Systems.ThesisEntitySpawningSystemMt8;
...
export class ThesisEntitySpawningSystemMt8 : public SystemThreaded
{
...
public:
	ThesisEntitySpawningSystemMt8(const int entityModificationsPerFrame, TextureLoader* textureLoader, MeshLoader* meshLoader, bool allowConcurrent) :
	...
	~ThesisEntitySpawningSystemMt8() override {}
...
protected:
	...
	void Update(const int thread, const double deltaTime) override 
	{
		...
		EntityTypeComponent8 entityType = {};
