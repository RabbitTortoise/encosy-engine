...
export module Thesis.Systems.ThesisEntitySpawningSystemMt1;
...
export class ThesisEntitySpawningSystemMt1 : public SystemThreaded
{
...
public:
	ThesisEntitySpawningSystemMt1(const int entityModificationsPerFrame, TextureLoader* textureLoader, MeshLoader* meshLoader, bool allowConcurrent) :
	...
	~ThesisEntitySpawningSystemMt1() override {}
...
protected:
	void Init() override
	{
		...
		SystemEntityType = GetEntityTypeInfo("EntityType1").Type;
	...
	void Update(const int thread, const double deltaTime) override 
	{
		...
		EntityTypeComponent1 entityType = {};
